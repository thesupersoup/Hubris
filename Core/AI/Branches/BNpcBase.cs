...
namespace Hubris
{
	...
	{
		private BhvStatus _status = BhvStatus.RUNNING;

		public BhvStatus Status { get { return _status; } protected set { _status = value; } }


		public virtual void Invoke( BhvTree b, Npc a )
		{
