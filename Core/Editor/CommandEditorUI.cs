...
namespace Hubris
{
	...
	public class CommandEditorUI : EditorWindow
	{
		...
		private Command.CmdType _type;      // What type of Command is it? See CmdType enum
		...
		void OnGUI()
		{
			...
			_type = (Command.CmdType)EditorGUILayout.EnumFlagsField(new GUIContent("Command Type", "What type of Command is it? See CmdType enum"), _type);
		...
		private void AddCommand(string ui, string name, Command.CmdType type, string data, bool cont)
		{
